...
GPS_bool GPS_getData(PmodGPS* InstancePtr) {
   ...
   if (ReceivedCount += XUartNs550_Recv(&InstancePtr->GPSUart,
         (u8*) InstancePtr->recv + ReceivedCount, MAX_SIZE)) {
